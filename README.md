...
For judgement I utilised the **Deepseek-V3-0324:free** model from openrouter. I forgot to read more on its rate limits and hence exhausted my daily limits in experimentation before I could run it for a last time to finalise my judgment results. However I did obtain some initial judgement results which are kinda interesting.
...
Here I compare the baseline jokes as well as the jokes generated from the plansearch inspired pipeline they are both judged independently of each other. For the plansearch inspired joke I provide the rubric, tone and other available originating details to the LLM judge.
...
Honestly, because the entire idea seems hilarious, I honestly cant think why I never thought of experimenting along these lines xD. Apart from the fun factor, I was also intrigued if at all the creative diversity of LLM generated slop could be improved with some framework.
...
The quality of small LLMs in the present day, I didnt expect gemma-3 4b deliver stellar or creative jokes, but its results exceeded my expectations in terms of creativity and diversity. Also was surprised by how well it ran on my 4060.
